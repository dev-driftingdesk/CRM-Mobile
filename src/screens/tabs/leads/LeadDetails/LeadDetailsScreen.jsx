  ...
  deals: [
    ...
    },
    {
      ...
      salesReps: [
        ...
        { id: '4', name: 'Emily Carter', avatar: null },
      ],
      talkingPoints: {
        fromLastCall: '22nd Tuesday',
        notes: 'Discussion about design package requirements and timeline.',
        bulletPoints: [
    ...
    },
    {
      ...
      talkingPoints: {
        ...
        notes: 'Bootcamp structure and enrollment details.',
        bulletPoints: [
      ...
      activityTimeline: [
        {
          id: 'a1',
          activity: 'Training materials prepared',
          timestamp: '9/27/2025 at 11:00 AM',
          duration: '2 hours',
          status: 'approved',
        },
      ],
    },
    {
      ...
      activityTimeline: [
        {
          id: 'a1',
          activity: 'Enrollment forms submitted',
          timestamp: '9/26/2025 at 09:30 AM',
          duration: '20 min',
          status: 'sent',
        },
      ],
